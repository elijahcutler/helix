...
## Overview
Helix is a self-hosted web application designed to manage AWS EC2 instances running Linux GSM game servers. The app provides an interface to check the status of EC2 instances, view instance details, and remotely start/stop game servers.
